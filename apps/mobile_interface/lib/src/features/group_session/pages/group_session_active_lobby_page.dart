      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            final mountainHeight = math.max(170.0, constraints.maxHeight * 0.30);
              ...
              child: Center(
                child: ConstrainedBox(
                  ...
                  Text(
                    allTurnsScored
                        ? (_micEnabled
                            ? 'Open discussion is live: tap mic to mute yourself.'
                            : 'Open discussion: tap mic to unmute.')
                        : (isMyTurn
                            ? (_turnMicActive
